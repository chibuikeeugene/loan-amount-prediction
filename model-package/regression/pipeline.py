...
loan_amount_pipeline =  Pipeline(
    ...
    ('missing_indicator', AddMissingIndicator(variables=config.model_config.num_var_na)),
    ...
    ('categorical_encoder', OneHotEncoder(
        drop_last=True, variables=config.model_config.cat_vars)),
    
    # === variable transformation ======

    ('log', LogCpTransformer(variables=config.model_config.num_cont_vars, C=config.model_config.C)),
